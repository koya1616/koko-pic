  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 p-4">
      ...
      <header className="flex items-center mb-4">
        ...
        <h1 className="text-lg font-semibold">撮影依頼：{request?.title || '依頼'}</h1>
      </header>
      ...
      <div className="bg-white p-3 rounded-lg mb-4 shadow-sm">
        <div className="font-medium">依頼内容：{request?.description || '依頼内容がありません'}</div>
        <div className="text-indigo font-semibold">報酬：¥{request?.reward || 0}</div>
      </div>
